...
SRC			=	ft_strndup.c ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
		  		...
		  		ft_toupper.c ft_putchr.c ft_itoa.c ft_lstdel.c ft_lstdelone.c \
				ft_lstadd.c ft_lstiter.c ft_lstmap.c ft_lstnew.c \
				ft_strim.c ft_swap.c \
...
clean		:
				@echo "> Cleaning object file from libft/"
				@/bin/rm -rf $(OBJ) libft.h.gch
